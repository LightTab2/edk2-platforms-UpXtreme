...
${GCC_AARCH64_PREFIX}ld edk2-elf.o -o edk2.elf -EL -T ${WORKSPACE}/edk2-platforms-UpXtreme/Silicon/Qualcomm/qcom-edk2-elf.lds --defsym=ELFENTRY=0x9fc00000 -Ttext=0x9fc00000
rm -f edk2-elf.o
